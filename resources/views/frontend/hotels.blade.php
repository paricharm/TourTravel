...
<body style="background-color: #fdfafa;">
    ...
    <section id="gallerytop" class="container-fluid mb-3">
        <div class="container col-lg-8 col-12 text-white">
            <h2 class="text-center heading">Experience comfort with our hotels.</h2>
            ...
            <div class="d-flex justify-content-between container col-3">
                ...
                <span>/</span>
                <a href="{{ route('destination') }}" class="text-light text-decoration-none">Tourist Places</a>
            </div>
        </div>
    </section>
